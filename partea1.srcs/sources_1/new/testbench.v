...
begin
    ...
    if (high_count == (high_per_period * num_periods)) begin
        $display("[PASS] PWM duty corect: high=%0d, exp=%0d",
                 high_count, high_per_period * num_periods);
    end else begin
        $display("[FAIL] PWM duty incorect: high=%0d, exp=%0d",
                 high_count, high_per_period * num_periods);
    end
end
endtask
    ...
    initial begin
        ...
        spi_write_reg(REG_COUNTER_EN, 8'h01);
        check_pwm_duty(7, 1, 3);//in loc de 0
